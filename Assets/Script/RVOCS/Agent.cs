...
namespace RVO
{
    ...
    internal class Agent
    {
        ...
        internal void computeNewVelocity()
        {
            ...
            for (int i = 0; i < obstacleNeighbors_.Count; ++i)
            {
                ...
                if (s < fp.zero && distSq1 <= radiusSq)
                {
                    ...
                    {
                        line.point = new Vector2(fp.zero, fp.zero);
            ...
            for (int i = 0; i < agentNeighbors_.Count; ++i)
            {
                ...
                else
                {
                    ...
                    fp invTimeStep = fp.one / simulator_.timeStep_;
         ...
         * </param>
         */
        private bool linearProgram1(IList<Line> lines, int lineNo, fp radius, Vector2 optVelocity, bool directionOpt, ref Vector2 result)
        {
         ...
         * </param>
         */
        private int linearProgram2(IList<Line> lines, fp radius, Vector2 optVelocity, bool directionOpt, ref Vector2 result)
        {
            if (directionOpt)
            {
                /*
         ...
         * </param>
         */
        private void linearProgram3(IList<Line> lines, int numObstLines, int beginLine, fp radius, ref Vector2 result)
        {
            fp distance = fp.zero;
