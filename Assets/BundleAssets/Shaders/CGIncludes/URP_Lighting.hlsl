...
#ifndef UNITY_URP_Lighting
#define UNITY_URP_Lighting
...
half3 DirectBRDF(BRDFData brdfData, half3 normalWS, half3 lightDirectionWS, half3 viewDirectionWS){
    ...
    half3 color = float3(specularTerm * brdfData.specular + brdfData.diffuse);
    return color;
}
*/
...
half4 UniversalFragmentPBR(InputData inputData, half3 albedo, half metallic, half3 specular, half smoothness,
